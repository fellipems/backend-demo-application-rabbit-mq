...
public class SenhaUtil {
    // Lógica de complexidade de senha por: https://passwordmeter.com/
    ...
    public static String encryptPassword(String password) {
        final String PASSWORD = "senha123"; // Senha para derivar a chave
        final String SALT = "salt123"; // Salt para derivar a chave
        final int KEY_LENGTH = 128; // Comprimento da chave em bits
